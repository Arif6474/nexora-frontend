                    ...
                    {authView !== "forgot-password" && (
                        <>
                            <button
                                ...
                                className="w-full flex items-center justify-center gap-3 py-4 bg-white border-2 border-stone-100 rounded-2xl font-black text-stone-900 hover:bg-stone-50 hover:border-stone-200 transition-all active:scale-[0.98] group"
                            >
